...
3. **Turns:** count down initiative. On their turn a combatant spends 1
   Action Point on **ONE Proactive Action — one per round, no more** (Mythras
   Imperative has no extra action cycles). Remaining AP may only be spent on
   Reactive Actions (Parry, Evade, Interrupt) when threatened. All ordinary
   characters have **2 AP per round**; unused AP do not carry over.
   `next-round` resets AP.
